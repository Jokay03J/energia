...
public class BatterieMiseAJourDuTickProcedure extends EnergiaModElements.ModElement {
	public BatterieMiseAJourDuTickProcedure(EnergiaModElements instance) {
		super(instance, 31);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure BatterieMiseAJourDuTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure BatterieMiseAJourDuTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure BatterieMiseAJourDuTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure BatterieMiseAJourDuTick!");
			return;
		}
		...
		if ((new Object() {
			...
			}.receiveEnergySimulate(new BlockPos((int) (x - 1), (int) y, (int) z), (int) (west)));
			{
				TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
		...
		if ((new Object() {
		...
		}.canReceiveEnergy(new BlockPos((int) (x + 1), (int) z, (int) y)))) {
			...
			}.receiveEnergySimulate(new BlockPos((int) (x + 1), (int) y, (int) z), (int) (east)));
			{
				TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
		...
		if ((new Object() {
			...
			}.receiveEnergySimulate(new BlockPos((int) x, (int) y, (int) (z + 1)), (int) (south)));
			{
				TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
		...
		if ((new Object() {
			...
			}.receiveEnergySimulate(new BlockPos((int) x, (int) y, (int) (z - 1)), (int) (north)));
			{
				TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
