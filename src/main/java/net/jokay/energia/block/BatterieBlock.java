...
import net.jokay.energia.procedures.BatterieMiseAJourDuTickProcedure;
...
public class BatterieBlock extends EnergiaModElements.ModElement {
	@ObjectHolder("energia:batterie")
	public static final Block block = null;
	@ObjectHolder("energia:batterie")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BatterieBlock(EnergiaModElements instance) {
		super(instance, 31);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("batterie"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).lightValue(0));
			setRegistryName("batterie");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BatterieMiseAJourDuTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("batterie");
		}
